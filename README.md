...
If `MONGODB_URI` is missing, the app still runs, but users/chats only live in memory for the current local process. For real deployment, set up MongoDB Atlas.
